                ...
                <div class="px-4 pt-5 pb-4 bg-modal sm:p-6 sm:pb-4 flex flex-col">
                    ...
                    <form>
                        <div class="flex flex-col mt-4">
                            ...
                            <div class="mt-4">
                                <input class="input-modal w-full" type="text" wire:model="name" placeholder="Name"/>
                            ...
                            <div class="mt-4">
                                <div class="flex flex-row items-center">
                                    <span class="ml-2 date">{{ Carbon\Carbon::parse($start_datetime)->format('j F') }}</span>
                                    <div class="ml-2 w-full relative">
                                        <input class="w-full input-modal" type="time" wire:model="start_datetime" placeholder="Event Start Time"/>
                                ...
                                @error('start_datetime') <span class="text-red-500">{{ $message }}</span> @enderror
                            </div>
                        ...
                        <div class="flex flex-row-reverse w-full p-2 mt-4">
                            <button class="add-button" wire:click="update({{ $eventId }})">Save</button>
                            <button class="button-no-bg mr-2" wire:click="delete({{ $eventId }})">Delete</button>
